  ...
  *(addr_jp1port + 4) = 0x00;
  ...
  while (true) {
    ...
    //Place Ship 1
    {
      ...
      while (true) {
        ...
        if (input & 0x01) {
          ...
          } while (pgrid[i1][j1].ship !=0 || pgrid[i2][j2].ship !=0 || pgrid[i3][j3].ship !=0);
        ...
        //Rotate Button
          ...
          if (rot) {
            if (!((i1 + 2) > 6 || pgrid[i1 + 1][j1].ship !=0 || pgrid[i1 + 2][j1].ship !=0)) {
              i2 = i1 + 1;
              i3 = i2 + 1;
              j2 = j1;
              j3 = j1;
            ...
            if (!((j1 + 2) > 6 || pgrid[i1][j1 + 1].ship !=0 || pgrid[i1][j1 + 2].ship !=0)) {
    ...
    for(int a=0;a<2;a++){
      ...
      bool rot = false;
      while (pgrid[i1][j1].ship != 0 || pgrid[i2][j2].ship != 0) {
        i1++;
        i2++;
        if (i1 == 6) {
          i1 = 0;
      ...
      while (true) {
        ...
        //Rotate Button
          ...
          if (rot) {
            if (!((i1 + 1) > 6 || pgrid[i1 + 1][j1].ship !=0)) {
              i2 = i1 + 1;
            ...
            if (!((j1 + 1) > 6 || pgrid[i1][j1 + 1].ship !=0)) {
